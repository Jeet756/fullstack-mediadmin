...
function Join() {
 ...
 const handleSubmit = async (e) => {
  ...
  <meta 
    name="description" 
    content="Apply for medical jobs including doctor, nurse, lab technician, and hospital staff positions. Join Shri Gurupad Hospital today." 
  />
  <meta 
    name="keywords" 
    content="hospital jobs, medical jobs, doctor jobs, nurse jobs, healthcare careers, hospital recruitment" 
  />
</Helmet>
        <div className="card" style={{ padding: dynamicPadding }}>
          <h1>Medical Jobs & Careers at Shri Gurupad Hospital</h1>
