...
const Appointment = () => {
  ...
  return (
    <main style={styles.container}>
      <Helmet>
  <title>Book Appointment | Shri Gurupad Hospital</title>
  <meta
    name="description"
    content="Book a doctor appointment at Shri Gurupad Hospital. Quick and easy online appointment booking with expert doctors."
  />
</Helmet>
      <h2 style={styles.heading}>Book Doctor Appointment Or Get a Call From Our Team</h2>
